...
const sendResetEmailOTP = async (to, subject, text, replacements, html) => {
  ...
  const templatePath = path.join(__dirname, "../templates/welcome-email-otp.html");
  ...
  htmlTemplate = htmlTemplate.replace('{{name}}', replacements.name);
  htmlTemplate = htmlTemplate.replace('{{otp}}', replacements.otp);
  htmlTemplate = htmlTemplate.replace('{{projectName}}', replacements.projectName);
  htmlTemplate = htmlTemplate.replace('{{companyAddress}}', replacements.companyAddress);
